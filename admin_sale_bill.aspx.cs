...
{
    public partial class admin_sale_bill : System.Web.UI.Page
    {

        SqlConnection con = new SqlConnection();
        SqlCommand cmd;
        String ID = "WEL#1411/18/151";
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            string billins = "insert into Sale_Report_tbl(Pname,Quantity,Size,Date,Bill_No,Price)values('" + DropDownList1.SelectedItem.Text.Trim() + "','" + txtqty.Text.Trim() + "','" + txtsize.Text.Trim() + "','" + txtdate.Text.Trim() + "','" + lblbillno.Text.Trim() + "','" + txtprice.Text.Trim() + "')";
