...
namespace My_Project
{
    ...
    public partial class Details : System.Web.UI.Page
    {
        ...
        {
            String sel = "Select Pcode,Size,Compname,Compcode,Quantity,Sgst,Cgst,Unit_Price,Tax_Amnt from product_details_tbl  where Pname='" + itemlist1.SelectedItem.Text + "'";
        ...
        {
            String update = "update product_details_tbl set Pcode='" + txtpcode.Text + "',Size='" + txtsize.Text + "',Compname='" + txtcompname.Text + "',Compcode='" + txtcompcode.Text + "',Quantity='" + txtqty.Text + "',Sgst='" + txtsgst.Text + "',Cgst='" + txtcgst.Text + "', Unit_Price='" + txtunit_price.Text + "',Tax_Amnt='" + txttax.Text + "'where Pname='" + itemlist1.SelectedItem.Text + "'";
        ...
        {
            String delete = ("delete from product_details_tbl  where [Pname]=('" + itemlist1.SelectedItem.Text + "' )");
