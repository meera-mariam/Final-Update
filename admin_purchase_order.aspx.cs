...
namespace Welgate_Organic_Projects
{
    public partial class admin_purchase_order : System.Web.UI.Page
    {
        ...
        protected void btnsubmit_Click(object sender, EventArgs e)
        {
            ...
            LoadSum();
            getcon();
            string ins = "insert into Purchase_Order_tbl (Date,Supplier,Payment_Terms,[Item Name],[Item Code],[Quantity],Price,Total)values('" + txtdate.Text.Trim() + "','" + txtsupplier.Text.Trim() + "','" + DropDownList2.SelectedItem.Text.Trim() + "','" + txtname.Text.Trim() + "','" + txtcode.Text.Trim() + "','" + txtqty.Text.Trim() + "','" + txtprice.Text.Trim() + "','" + txtnettotal.Text.Trim() + "')";
        ...
        protected void btnsearch1_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                txtsupplier.Text = dt.Rows[0][4].ToString();
            }
            con.Close();
        }
